...
final sub5 = DormMenu();
final sub6 = EvacuationFacility();

final List category = [cat1, cat2, cat3, cat4];

final List keywords = ['통근버스', '통근', '2층', '3층', '5층', '교직원', '기숙사', '생활관', '지도','대피시설',];
final List subpage = [sub1, sub1, sub2, sub3, sub4, sub4, sub5, sub5, sub6, sub6,];